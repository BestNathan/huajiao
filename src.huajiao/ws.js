!(function(e, t) {
  ...
  ;(e.fromInt = function(r, n) {
    ...
    return n
      ? 0 <= (r >>>= 0) && r < 256 && (s = i[r])
        ? s
        : ((o = new e(r, (0 | r) < 0 ? -1 : 0, !0)), 0 <= r && r < 256 && (i[r] = o), o)
      : -128 <= (r |= 0) && r < 128 && (s = t[r])
        ? s
        : ((o = new e(r, r < 0 ? -1 : 0, !1)), -128 <= r && r < 128 && (t[r] = o), o)
  }),
    ...
    (e.fromString = function(t, i, r) {
      ...
      if (('number' == typeof i && ((r = i), (i = !1)), (r = r || 10) < 2 || 36 < r))
      ...
      for (var o = e.fromNumber(Math.pow(r, 8)), s = e.ZERO, a = 0; a < t.length; a += 8) {
        ...
        if (l < 8) {
          var h = e.fromNumber(Math.pow(r, l))
          s = s.multiply(h).add(e.fromNumber(f))
  ...
  return (
    ...
    (e.prototype.add = function(t) {
      ...
      return (
        ...
        (h += i + s),
        (h &= 65535),
        e.fromBits((p << 16) | d, (h << 16) | u, this.unsigned)
      )
    }),
    ...
    (e.prototype.multiply = function(t) {
      ...
      if (this.lessThan(s) && t.lessThan(s)) return e.fromNumber(this.toNumber() * t.toNumber(), this.unsigned)
      var i = this.high >>> 16,
        r = 65535 & this.high,
        n = this.low >>> 16,
        o = 65535 & this.low,
      ...
      return (
        ...
        (u += i * h + r * f + n * l + o * a),
        (u &= 65535),
        e.fromBits((d << 16) | c, (u << 16) | p, this.unsigned)
      )
    }),
        ...
        return (
          ...
          i.equals(e.ZERO)
            ? t.isNegative()
              ? e.ONE
              : e.NEG_ONE
            : ((r = this.subtract(t.multiply(i))), (n = i.add(r.div(t))))
        )
      }
      ...
      for (n = e.ZERO, r = this; r.greaterThanOrEqual(t); ) {
        ...
        for (
          var o = Math.ceil(Math.log(i) / Math.LN2),
            s = o <= 48 ? 1 : Math.pow(2, o - 48),
            a = e.fromNumber(i),
            l = a.multiply(t);
          l.isNegative() || l.greaterThan(r);

        )
          (i -= s), (a = e.fromNumber(i, this.unsigned)), (l = a.multiply(t))
        a.isZero() && (a = e.ONE), (n = n.add(a)), (r = r.subtract(l))
      }
      return n
    }),
    ...
    (e.prototype.shiftLeft = function(t) {
      return (
        ...
        0 == (t &= 63)
          ? this
          : t < 32
            ? e.fromBits(this.low << t, (this.high << t) | (this.low >>> (32 - t)), this.unsigned)
    ...
    (e.prototype.shiftRight = function(t) {
      return (
        ...
        0 == (t &= 63)
          ? this
          : t < 32
            ? e.fromBits((this.low >>> t) | (this.high << (32 - t)), this.high >> t, this.unsigned)
  ...
  (function(e, t) {
    ...
    function i() {
      var e = [],
        t = []
      return function() {
        if (0 === arguments.length) return t.join('') + l.apply(String, e)
        e.length + arguments.length > 1024 && (t.push(l.apply(String, e)), (e.length = 0)),
    ...
    function r(e, t, i, r, n) {
      var o,
        ...
        p = i ? -1 : 1,
        d = e[t + u]
      for (u += p, o = d & ((1 << -h) - 1), d >>= -h, h += a; h > 0; o = 256 * o + e[t + u], u += p, h -= 8);
      for (s = o & ((1 << -h) - 1), o >>= -h, h += r; h > 0; s = 256 * s + e[t + u], u += p, h -= 8);
      if (0 === o) o = 1 - f
      else {
        if (o === l) return s ? NaN : (d ? -1 : 1) * Infinity
        ;(s += Math.pow(2, r)), (o -= f)
      }
    ...
    var o = function(e, t, i) {
      if (
        (void 0 === e && (e = o.DEFAULT_CAPACITY),
        void 0 === t && (t = o.DEFAULT_ENDIAN),
        void 0 === i && (i = o.DEFAULT_NOASSERT),
        !i)
      ) {
    ...
    ;(o.accessor = function() {
      ...
      (o.concat = function(e, t, i, r) {
        ;('boolean' != typeof t && 'string' == typeof t) || ((r = i), (i = t), (t = undefined))
        for (var n, s = 0, a = 0, l = e.length; a < l; ++a)
          o.isByteBuffer(e[a]) || (e[a] = o.wrap(e[a], t)), (n = e[a].limit - e[a].offset) > 0 && (s += n)
        if (0 === s) return new o(0, i, r)
        var f,
          h = new o(s, i, r)
        for (a = 0; a < l; )
          (f = e[a++]),
            (n = f.limit - f.offset) <= 0 || (h.view.set(f.view.subarray(f.offset, f.limit), h.offset), (h.offset += n))
      ...
      (o.wrap = function(e, t, i, r) {
        if (('string' != typeof t && ((r = i), (i = t), (t = undefined)), 'string' == typeof e))
      ...
      (s.readInt16 = function(e) {
        ...
        return (
          this.littleEndian
            ? ((i = this.view[e]), (i |= this.view[e + 1] << 8))
            : ((i = this.view[e] << 8), (i |= this.view[e + 1])),
      ...
      (s.writeVarint32 = function(e, t) {
        ...
        var r,
          n = o.calculateVarint32(e)
        t += n
        var s = this.buffer.byteLength
        for (t > s && this.resize((s *= 2) > t ? s : t), t -= n, e >>>= 0; e >= 128; )
          (r = (127 & e) | 128), (this.view[t++] = r), (e >>>= 7)
      ...
      (s.writeCString = function(e, i) {
        ...
        ;(o = h.calculateUTF16asUTF8(t(e))[1]), (i += o + 1)
        var s = this.buffer.byteLength
        return (
      ...
      (s.readCString = function(e) {
        ...
        return (
          ...
          t ? ((this.offset = e), r()) : { string: r(), length: e - n }
        )
      }),
      (s.writeIString = function(e, i) {
        ...
        var n,
          o = i
        ;(n = h.calculateUTF16asUTF8(t(e), this.noAssert)[1]), (i += 4 + n)
        var s = this.buffer.byteLength
        if (
          (i > s && this.resize((s *= 2) > i ? s : i),
          (i -= 4 + n),
          this.littleEndian
            ? ((this.view[i + 3] = (n >>> 24) & 255),
              (this.view[i + 2] = (n >>> 16) & 255),
              (this.view[i + 1] = (n >>> 8) & 255),
              (this.view[i] = 255 & n))
            : ((this.view[i] = (n >>> 24) & 255),
      ...
      (s.readIString = function(e) {
        ...
        return (
          h.decodeUTF8toUTF16(
            function() {
              return e < a ? this.view[e++] : null
            }.bind(this),
            (s = i()),
            this.noAssert
          ),
          (r = s()),
          t ? ((this.offset = e), r) : { string: r, length: e - o }
        )
      }),
      (o.METRICS_CHARS = 'c'),
      (o.METRICS_BYTES = 'b'),
      (s.writeUTF8String = function(e, i) {
        ...
        var n,
          o = i
        ;(n = h.calculateUTF16asUTF8(t(e))[1]), (i += n)
        var s = this.buffer.byteLength
        return (
          i > s && this.resize((s *= 2) > i ? s : i),
          (i -= n),
          ...
          r ? ((this.offset = i), this) : i - o
        )
      }),
      (s.writeString = s.writeUTF8String),
      (o.calculateUTF8Chars = function(e) {
        return h.calculateUTF16asUTF8(t(e))[0]
      }),
      (o.calculateUTF8Bytes = function(e) {
        return h.calculateUTF16asUTF8(t(e))[1]
      }),
      (o.calculateString = o.calculateUTF8Bytes),
      (s.readUTF8String = function(e, t, r) {
        'number' == typeof t && ((r = t), (t = undefined))
        var n = void 0 === r
        if ((n && (r = this.offset), void 0 === t && (t = o.METRICS_CHARS), !this.noAssert)) {
      ...
      (s.writeVString = function(e, i) {
        ...
        var n,
          s,
          a = i
        ;(n = h.calculateUTF16asUTF8(t(e), this.noAssert)[1]), (s = o.calculateVarint32(n)), (i += s + n)
        var l = this.buffer.byteLength
        if (
          (i > l && this.resize((l *= 2) > i ? l : i),
          (i -= s + n),
      ...
      (s.append = function(e, t, i) {
        ;('number' != typeof t && 'string' == typeof t) || ((i = t), (t = undefined))
        var r = void 0 === i
        if ((r && (i = this.offset), !this.noAssert)) {
          if ('number' != typeof i || i % 1 != 0) throw TypeError('Illegal offset: ' + i + ' (not an integer)')
          if ((i >>>= 0) < 0 || i + 0 > this.buffer.byteLength)
      ...
      (s.clone = function(e) {
        ...
        return (
          e
            ? ((t.buffer = new ArrayBuffer(this.buffer.byteLength)), (t.view = new Uint8Array(t.buffer)))
      ...
      (s.prepend = function(e, t, i) {
        ...
        return (
          this.view.set(e.view.subarray(e.offset, e.limit), i - n), (e.offset = e.limit), r && (this.offset -= n), this
        )
      }),
      ...
      (s.reset = function() {
        return (
          this.markedOffset >= 0 ? ((this.offset = this.markedOffset), (this.markedOffset = -1)) : (this.offset = 0),
          this
        )
      }),
      (s.resize = function(e) {
        ...
        (e.decode = function(e, t) {
          ...
          for (var n, o, s; null !== (n = e()); )
            if (
              ...
              void 0 === o && r(n),
              null !== (n = e()) &&
                ((s = i[n]), void 0 === s && r(n), t(((o << 2) >>> 0) | ((48 & s) >> 4)), null !== (n = e())))
            ) {
              if (void 0 === (o = i[n])) {
                if (61 === n) break
                r(n)
    ...
    ;(s.toBase64 = function(e, t) {
      ...
      (s.toBinary = function(e, t) {
        ...
        if (e === t) return ''
        for (var i = [], r = []; e < t; )
          i.push(this.view[e++]), i.length >= 1024 && (r.push(String.fromCharCode.apply(String, i)), (i = []))
      ...
      (o.fromBinary = function(e, t, i) {
        ...
        for (var r, n = 0, s = e.length, a = new o(s, t, i); n < s; ) {
          if (((r = e.charCodeAt(n)), !i && r > 255))
      ...
      (s.toDebug = function(e) {
        for (var t, i = -1, r = this.buffer.byteLength, n = '', o = '', s = ''; i < r; ) {
          if (
            (-1 !== i &&
              ((t = this.view[i]),
        ...
        for (
          ...
          switch ((r = e.charAt(l++))) {
            case '!':
              ...
              ;(a.offset = a.markedOffset = a.limit = f), (h = !1)
              break
            case '|':
              if (!i) {
                if (u || d) {
            ...
            default:
              ...
              if (((n = parseInt(r + e.charAt(l++), 16)), !i && (isNaN(n) || n < 0 || n > 255)))
      ...
      (s.toHex = function(e, t) {
        ...
        for (var i, r = new Array(t - e); e < t; )
          (i = this.view[e++]), i < 16 ? r.push('0', i.toString(16)) : r.push(i.toString(16))
        return r.join('')
      }),
      (o.fromHex = function(e, t, i) {
        ...
        for (var r, n = e.length, s = new o((n / 2) | 0, t), a = 0, l = 0; a < n; a += 2) {
          if (((r = parseInt(e.substring(a, a + 2), 16)), !i && (!isFinite(r) || r < 0 || r > 255)))
      ...
      return (
        ...
        (e.decodeUTF8 = function(e, t) {
          for (
            ...
            if (0 == (128 & i)) t(i)
            else if (192 == (224 & i)) null === (r = e()) && s([i, r]), t(((31 & i) << 6) | (63 & r))
            else if (224 == (240 & i))
        ...
        (e.UTF8toUTF16 = function(e, t) {
          ...
          for (
            ...
            i <= 65535 ? t(i) : ((i -= 65536), t(55296 + (i >> 10)), t(i % 1024 + 56320)), (i = null)
        }),
    ...
    return (
      ...
      (o.fromUTF8 = function(e, i, r) {
        ...
        var n = new o(h.calculateUTF16asUTF8(t(e), !0)[1], i, r),
          s = 0
        return (
          h.encodeUTF16toUTF8(t(e), function(e) {
            n.view[s++] = e
          }),
          (n.limit = s),
          n
  ...
  (function(e, t) {
    'function' == typeof define && define.amd
      ? define(['ByteBuffer'], t)
      : 'function' == typeof require && 'object' == typeof module && module && module.exports
        ? (module.exports = t(require('bytebuffer')))
    ...
    return (
      ...
      (t.TYPES = {
        int32: { name: 'int32', wireType: t.WIRE_TYPES.VARINT, defaultValue: 0 },
        ...
        int64: { name: 'int64', wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.ZERO : undefined },
        uint64: { name: 'uint64', wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.UZERO : undefined },
        sint64: { name: 'sint64', wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.ZERO : undefined },
        ...
        fixed64: { name: 'fixed64', wireType: t.WIRE_TYPES.BITS64, defaultValue: t.Long ? t.Long.UZERO : undefined },
        sfixed64: { name: 'sfixed64', wireType: t.WIRE_TYPES.BITS64, defaultValue: t.Long ? t.Long.ZERO : undefined },
      ...
      (t.Util = (function() {
        var e = {}
        return (
          (e.IS_NODE = !('object' != typeof process || process + '' != '[object process]')),
          (e.XHR = function() {
            for (
              var e = [
                  function() {
            ...
            if ((i && 'function' != typeof i && (i = null), e.IS_NODE))
              ...
              if (
                ((r.onreadystatechange = function() {
                  4 == r.readyState &&
                    i(200 == r.status || (0 == r.status && 'string' == typeof r.responseText) ? r.responseText : null)
                }),
                4 == r.readyState)
              )
                return
      ...
      (t.DotProto = (function(e, t) {
        ...
        ;(n._readString = function() {
          ...
          (n.next = function() {
            ...
            if (this.index === this.source.length) return null
            var r = this.index
            if (((t.DELIM.lastIndex = 0), t.DELIM.test(this.source.charAt(r)))) ++r
            else for (++r; r < this.source.length && !t.DELIM.test(this.source.charAt(r)); ) r++
            var n = this.source.substring(this.index, (this.index = r))
            return (
              n === t.STRINGOPEN
                ? ((this.readingString = !0), (this.stringEndsWith = t.STRINGCLOSE))
                : n === t.STRINGOPEN_SQ && ((this.readingString = !0), (this.stringEndsWith = t.STRINGCLOSE_SQ)),
              n
            )
          }),
          (n.peek = function() {
        ...
        return (
          (s.parse = function() {
            for (
              var e,
                t = { name: '[ROOT]', package: null, messages: [], enums: [], imports: [], options: {}, services: [] },
                i = !0;
              (e = this.tn.next());
          ...
          (s._parseNumber = function(e) {
            ...
            if (t.NUMBER_FLT.test(e)) return 'inf' === e ? i * Infinity : 'nan' === e ? NaN : i * parseFloat(e)
            throw Error('Illegal number at line ' + this.tn.line + ': ' + (i < 0 ? '-' : '') + e)
          }),
          (s._parseString = function() {
            var e,
              ...
              r = ''
            do {
              if (((i = this.tn.next()), (r += this.tn.next()), (e = this.tn.next()) !== i))
          ...
          (s._parseId = function(e, i) {
            ...
            if (('-' == e.charAt(0) && ((n = -1), (e = e.substring(1))), t.NUMBER_DEC.test(e))) r = parseInt(e)
              ...
              if (!t.NUMBER_OCT.test(e))
                throw Error('Illegal id at line ' + this.tn.line + ': ' + (n < 0 ? '-' : '') + e)
          ...
          (s._parsePackage = function(e) {
            ...
            var i = e
            if ((e = this.tn.next()) != t.END) throw Error('Illegal end of package at line ' + this.tn.line + ': ' + e)
            return i
          }),
          (s._parseImport = function(e) {
            if (
              ((e = this.tn.peek()),
              'public' === e && (this.tn.next(), (e = this.tn.peek())),
              e !== t.STRINGOPEN && e !== t.STRINGOPEN_SQ)
            )
              throw Error('Illegal start of import at line ' + this.tn.line + ': ' + e)
            var i = this._parseString()
            if ((e = this.tn.next()) !== t.END) throw Error('Illegal end of import at line ' + this.tn.line + ': ' + e)
            return i
          }),
          (s._parseOption = function(e, i) {
            ...
            var r = !1
            if (
              (i == t.COPTOPEN && ((r = !0), (i = this.tn.next())), !t.TYPEREF.test(i) && !/google\.protobuf\./.test(i))
            )
            ...
            if (((i = this.tn.next()), r)) {
              if (i !== t.COPTCLOSE)
                throw Error(
                  'Illegal end in message ' + e.name + ', option ' + n + ' at line ' + this.tn.line + ': ' + i
                )
              ;(n = '(' + n + ')'), (i = this.tn.next()), t.FQTYPEREF.test(i) && ((n += i), (i = this.tn.next()))
            }
            if (i !== t.EQUAL)
              throw Error(
                'Illegal operator in message ' + e.name + ', option ' + n + ' at line ' + this.tn.line + ': ' + i
              )
            var o
            if ((i = this.tn.peek()) === t.STRINGOPEN || i === t.STRINGOPEN_SQ) o = this._parseString()
            else if ((this.tn.next(), t.NUMBER.test(i))) o = this._parseNumber(i, !0)
            else if (t.BOOL.test(i)) o = 'true' === i
            else {
              if (!t.TYPEREF.test(i))
                throw Error(
                  'Illegal option value in message ' + e.name + ', option ' + n + ' at line ' + this.tn.line + ': ' + i
                )
              o = i
            }
            if ((i = this.tn.next()) !== t.END)
              throw Error(
                'Illegal end of option in message ' + e.name + ', option ' + n + ' at line ' + this.tn.line + ': ' + i
              )
            e.options[n] = o
          }),
          (s._parseIgnoredStatement = function(e, i) {
            for (var r; ; ) {
              if (null === (r = this.tn.next()))
                throw Error('Unexpected EOF in ' + e.name + ', ' + i + ' at line ' + this.tn.line)
              if (r === t.END) break
            }
          }),
          (s._parseService = function(e, i) {
            if (((i = this.tn.next()), !t.NAME.test(i)))
              throw Error('Illegal service name at line ' + this.tn.line + ': ' + i)
            var r = i,
              n = { name: r, rpc: {}, options: {} }
            if ((i = this.tn.next()) !== t.OPEN)
              throw Error('Illegal start of service ' + r + ' at line ' + this.tn.line + ': ' + i)
            do {
              if ('option' === (i = this.tn.next())) this._parseOption(n, i)
              else if ('rpc' === i) this._parseServiceRPC(n, i)
              else if (i !== t.CLOSE)
          ...
          (s._parseServiceRPC = function(e, i) {
            ...
            var n = i,
              o = { request: null, response: null, request_stream: !1, response_stream: !1, options: {} }
            if ((i = this.tn.next()) !== t.COPTOPEN)
              throw Error(
                'Illegal start of request type in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i
              )
            if (
              ((i = this.tn.next()),
              'stream' === i.toLowerCase() && ((o.request_stream = !0), (i = this.tn.next())),
              !t.TYPEREF.test(i))
            )
              throw Error('Illegal request type in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i)
            if (((o.request = i), (i = this.tn.next()) != t.COPTCLOSE))
              throw Error(
                'Illegal end of request type in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i
              )
            if (((i = this.tn.next()), 'returns' !== i.toLowerCase()))
              throw Error('Illegal delimiter in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i)
            if ((i = this.tn.next()) != t.COPTOPEN)
              throw Error(
                'Illegal start of response type in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i
              )
            if (
              ((i = this.tn.next()),
              'stream' === i.toLowerCase() && ((o.response_stream = !0), (i = this.tn.next())),
              (o.response = i),
              (i = this.tn.next()) !== t.COPTCLOSE)
            )
              throw Error(
                'Illegal end of response type in service ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i
              )
            if ((i = this.tn.next()) === t.OPEN) {
              do {
                if ('option' === (i = this.tn.next())) this._parseOption(o, i)
                else if (i !== t.CLOSE)
                  throw Error(
                    'Illegal start of option inservice ' + e.name + '#' + n + ' at line ' + this.tn.line + ': ' + i
                  )
              } while (i !== t.CLOSE)
          ...
          (s._parseMessage = function(e, i, r) {
            var n = {},
              o = 'group' === r
            if (((r = this.tn.next()), !t.NAME.test(r)))
              throw Error(
                'Illegal ' +
                  (o ? 'group' : 'message') +
                  ' name' +
            ...
            if (((n.name = r), o)) {
              ...
              try {
                ...
                throw Error(
                  'Illegal field id value for group ' + n.name + '#' + i.name + ' at line ' + this.tn.line + ': ' + r
                )
              }
              n.isGroup = !0
            }
            if (
              ...
              (n.oneofs = {}),
              (r = this.tn.next()),
              r === t.OPTOPEN && i && (this._parseFieldOptions(n, i, r), (r = this.tn.next())),
              r !== t.OPEN)
            )
              throw Error(
                'Illegal start of ' + (o ? 'group' : 'message') + ' ' + n.name + ' at line ' + this.tn.line + ': ' + r
              )
            for (;;) {
              if ((r = this.tn.next()) === t.CLOSE) {
                ;(r = this.tn.peek()), r === t.END && this.tn.next()
                break
              }
              if (t.RULE.test(r)) this._parseMessageField(n, r)
              else if ('oneof' === r) this._parseMessageOneOf(n, r)
              else if ('enum' === r) this._parseEnum(n, r)
              else if ('message' === r) this._parseMessage(n, null, r)
              else if ('option' === r) this._parseOption(n, r)
              else if ('extensions' === r) n.extensions = this._parseExtensions(n, r)
              else if ('extend' === r) this._parseExtend(n, r)
              else {
                if (!t.TYPEREF.test(r))
          ...
          (s._parseMessageField = function(e, i, r) {
            var n = {},
              o = null
            if (((n.rule = i), (n.options = {}), (i = void 0 !== r ? r : this.tn.next()), 'map' === n.rule)) {
              if (i !== t.LT) throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((i = this.tn.next()), !t.TYPE.test(i) && !t.TYPEREF.test(i)))
                throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((n.keytype = i), (i = this.tn.next()) !== t.COMMA))
                throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((i = this.tn.next()), !t.TYPE.test(i) && !t.TYPEREF.test(i)))
                throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((n.type = i), (i = this.tn.next()) !== t.GT))
                throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((i = this.tn.next()), !t.NAME.test(i)))
                throw Error('Illegal token in message ' + e.name + ' at line ' + this.tn.line + ': ' + i)
              if (((n.name = i), (i = this.tn.next()) !== t.EQUAL))
              ...
              try {
                ...
                throw Error(
                  'Illegal field id in message ' + e.name + '#' + n.name + ' at line ' + this.tn.line + ': ' + i
                )
              }
              if (
                ((i = this.tn.next()),
                i === t.OPTOPEN && (this._parseFieldOptions(e, n, i), (i = this.tn.next())),
                i !== t.END)
              )
                throw Error(
                  'Illegal delimiter in message ' + e.name + '#' + n.name + ' at line ' + this.tn.line + ': ' + i
                )
            } else if ('group' === i) {
              if (((o = this._parseMessage(e, n, i)), !/^[A-Z]/.test(o.name)))
              ...
              if (((n.type = i), (i = this.tn.next()), !t.NAME.test(i)))
          ...
          (s._parseMessageOneOf = function(e, i) {
            ...
            for (; this.tn.peek() !== t.CLOSE; )
              (r = this._parseMessageField(e, 'optional')), (r.oneof = n), o.push(r.id)
            this.tn.next(), (e.oneofs[n] = o)
          }),
          (s._parseFieldOptions = function(e, i, r) {
            for (var n = !0; ; ) {
              if ((r = this.tn.next()) === t.OPTCLOSE) break
              if (r === t.OPTEND) {
                if (n)
                  throw Error(
          ...
          (s._parseFieldOption = function(e, i, r) {
            var n = !1
            if ((r === t.COPTOPEN && ((r = this.tn.next()), (n = !0)), !t.TYPEREF.test(r)))
            ...
            var s
            if ((r = this.tn.peek()) === t.STRINGOPEN || r === t.STRINGOPEN_SQ) s = this._parseString()
            else if (t.NUMBER.test(r, !0)) s = this._parseNumber(this.tn.next(), !0)
            else if (t.BOOL.test(r)) s = 'true' === this.tn.next().toLowerCase()
            else {
              if (!t.TYPEREF.test(r))
                throw Error(
          ...
          (s._parseEnumValue = function(e, i) {
            var r = {}
            if (((r.name = i), (i = this.tn.next()) !== t.EQUAL))
            ...
            if ((e.values.push(r), (i = this.tn.next()) === t.OPTOPEN)) {
              var n = { options: {} }
              this._parseFieldOptions(e, n, i), (i = this.tn.next())
            }
          ...
          (s._parseExtensions = function(i, r) {
            ...
            if (
              ((r = this.tn.next()),
              'min' === r ? n.push(e.ID_MIN) : 'max' === r ? n.push(e.ID_MAX) : n.push(this._parseNumber(r)),
              (r = this.tn.next()) !== t.END)
            )
              throw Error('Illegal extensions delimiter in message ' + i.name + ' at line ' + this.tn.line + ': ' + r)
            return n
          }),
          (s._parseExtend = function(e, i) {
            if (((i = this.tn.next()), !t.TYPEREF.test(i)))
              throw Error('Illegal message name at line ' + this.tn.line + ': ' + i)
            var r = {}
            if (((r.ref = i), (r.fields = []), (i = this.tn.next()) !== t.OPEN))
          ...
          (s._parseSyntax = function(e) {
            ...
            if ((i = this.tn.peek()) !== t.STRINGOPEN && i !== t.STRINGOPEN_SQ)
              throw Error('Illegal token at line ' + this.tn.line + ': ' + i)
            var r = this._parseString()
            if ((i = this.tn.next()) !== t.END) throw Error('Illegal token at line ' + this.tn.line + ': ' + i)
            return r
          }),
          (s.toString = function() {
            return 'Parser'
      ...
      (t.Reflect = (function(t) {
        function i(i) {
          if (('string' == typeof i && (i = t.TYPES[i]), 'undefined' == typeof i.defaultValue))
        ...
        ;(f.getChildren = function(e) {
          ...
          (f.resolve = function(e, t) {
            ...
            do {
              do {
                ...
                if (!(s = r.getChild(i[n])) || !(s instanceof o.T) || (t && !(s instanceof o.Namespace))) {
                  r = null
                  break
                }
                ;(r = s), n++
          ...
          (f.build = function() {
            for (var e, t = {}, i = this.children, r = 0, n = i.length; r < n; ++r)
              (e = i[r]) instanceof l && (t[e.name] = e.build())
          ...
          (f.getOption = function(e) {
            return void 0 === e ? this.options : 'undefined' != typeof this.options[e] ? this.options[e] : null
          }),
          (o.Namespace = l)
        var h = function(e, i, r, n) {
            if (
              ((this.type = e),
              (this.resolvedType = i),
              (this.isMapKey = r),
        ...
        ;(u.defaultFieldValue = i),
          (u.verifyValue = function(i) {
            ...
            switch (this.type) {
              ...
              case t.TYPES.message:
                if (
                  ((i && 'object' == typeof i) || n(typeof i, 'object expected'), i instanceof this.resolvedType.clazz)
                )
                  return i
            ...
            throw Error(
              '[INTERNAL] Illegal value for ' + this.toString(!0) + ': ' + i + ' (undefined type ' + this.type + ')'
            )
          }),
          ...
          (u.encodeValue = function(i, r, n) {
            ...
            switch (this.type) {
              ...
              case t.TYPES.bool:
                'string' == typeof r
                  ? n.writeVarint32('false' === r.toLowerCase() ? 0 : !!r)
                  : n.writeVarint32(r ? 1 : 0)
                break
              case t.TYPES['enum']:
                n.writeVarint32(r)
                break
        ...
        ;(d.build = function(i) {
          ...
          var r = (function(t, i) {
            function r(i, n, o, s, a) {
              ...
              if (null === i || 'object' != typeof i) {
                if (s == t.TYPES['enum'])
                  for (var f = a.getChildren(t.Reflect.Enum.Value), h = 0; h < f.length; h++)
                    if (f[h].id === i) {
                      i = f[h].name
                      break
                    }
                l = i
              } else if (e.isByteBuffer(i)) l = n ? i.toBase64() : i.toBuffer()
              else if (Array.isArray(i)) {
                var u = i
                l = []
                for (var p = 0; p < u.length; p++) l.push(r(u[p], n, o, s, a))
              } else if (i instanceof t.Map) {
                var d = i.entries()
                l = {}
                for (var c = d.next(); !c.done; c = d.next())
                  l[i.keyElem.valueToString(c.value[0])] = r(
                    c.value[1],
                    n,
                    o,
                    i.valueElem.type,
                    i.valueElem.resolvedType
                  )
              } else if (i instanceof t.Long) l = o ? i.toString() : new t.Long(i)
              else {
                l = {}
                var g = i.$type,
                  m = undefined
                for (var h in i)
                  if (i.hasOwnProperty(h)) {
                    var y = i[h]
                    g && (m = g.getChild(h)), (l[h] = r(y, n, o, m.type, m.resolvedType))
                  }
              }
              return l
            }
            var n = i.getChildren(t.Reflect.Message.Field),
              ...
              s = function(r, a) {
                ...
                for (var l = 0, f = o.length; l < f; ++l) this[o[l].name] = null
                for (l = 0, f = n.length; l < f; ++l) {
                  var h = n[l]
                  ;(this[h.name] = h.repeated ? [] : h.map ? new t.Map(h) : null),
                    (!h.required && 'proto3' !== i.syntax) || null === h.defaultValue || (this[h.name] = h.defaultValue)
                }
                if (arguments.length > 0) {
                  ...
                  if (
                    ...
                    null === r ||
                    'object' != typeof r ||
                    !('function' != typeof r.encode || r instanceof s) ||
                    Array.isArray(r) ||
                    r instanceof t.Map ||
                    e.isByteBuffer(r) ||
                    r instanceof ArrayBuffer ||
                    (t.Long && r instanceof t.Long)
                  )
                    for (l = 0, f = arguments.length; l < f; ++l)
                      void 0 !== (u = arguments[l]) && this.$set(n[l].name, u)
                  else this.$set(r)
                }
              },
            ...
            ;(a.add = function(e, r, n) {
              ...
              (a.set = function(e, r, n) {
                if (e && 'object' == typeof e) {
                  n = r
                  for (var o in e) e.hasOwnProperty(o) && void 0 !== (r = e[o]) && this.$set(o, r, n)
                  return this
                }
                ...
                return (
                  s &&
                    s.oneof &&
                    (null !== r
                      ? (null !== this[s.oneof.name] && (this[this[s.oneof.name]] = null),
                        (this[s.oneof.name] = s.name))
                      : s.oneof.name === e && (this[s.oneof.name] = null)),
                  this
                )
              }),
              (a.$set = a.set),
            ...
            for (var l = 0; l < n.length; l++) {
              var f = n[l]
              f instanceof t.Reflect.Message.ExtensionField ||
            ...
            ;(a.encode = function(t, r) {
              'boolean' == typeof t && ((r = t), (t = undefined))
              var n = !1
              t || ((t = new e()), (n = !0))
              ...
              (s.decode = function(t, r) {
                'string' == typeof t && (t = e.wrap(t, r || 'base64')), (t = e.isByteBuffer(t) ? t : e.wrap(t))
              ...
              (s.decodeDelimited = function(t, r) {
                if (
                  ('string' == typeof t && (t = e.wrap(t, r || 'base64')),
            ...
            return (
              Object.defineProperty &&
                (Object.defineProperty(s, '$options', { value: i.buildOpt() }),
                Object.defineProperty(a, '$options', { value: s.$options }),
                Object.defineProperty(s, '$type', { value: i }),
                Object.defineProperty(a, '$type', { value: i })),
              s
            )
          })(t, this)
          ;(this._fields = []), (this._fieldsById = {}), (this._fieldsByName = {})
          for (var n, o = 0, s = this.children.length; o < s; o++)
            if ((n = this.children[o]) instanceof E || n instanceof p || n instanceof b) {
              ...
              n.build(), this._fields.push(n), (this._fieldsById[n.id] = n), (this._fieldsByName[n.name] = n)
            else if (!(n instanceof p.OneOf || n instanceof w))
          ...
          (d.calculate = function(e) {
            for (var t, i, r = 0, n = 0, o = this._fields.length; n < o; ++n) {
              if (((t = this._fields[n]), (i = e[t.name]), t.required && null === i))
          ...
          (d.decode = function(e, i, r) {
            ...
            for (
              var o, s, a, l, f = e.offset, h = new this.clazz();
              e.offset < f + i || (-1 === i && e.remaining() > 0);
              ...
              if ((l = this._fieldsById[a]))
                if (l.repeated && !l.options.packed) h[l.name].push(l.decode(s, e))
                else if (l.map) {
                  var u = l.decode(s, e)
                  h[l.name].set(u[0], u[1])
                } else
                  (h[l.name] = l.decode(s, e)),
                    l.oneof &&
                      (null !== this[l.oneof.name] && (this[this[l.oneof.name]] = null), (h[l.oneof.name] = l.name))
              else
                switch (s) {
                  case t.WIRE_TYPES.VARINT:
                    e.readVarint32()
                  ...
                  default:
                    throw Error(
                      'Illegal wire type for unknown field ' + a + ' in ' + this.toString(!0) + '#decode: ' + s
                    )
                }
            }
            for (var d = 0, c = this._fields.length; d < c; ++d)
              if (((l = this._fields[d]), null === h[l.name])) {
                if (l.required) {
                  var g = Error('Missing at least one required field for ' + this.toString(!0) + ': ' + l.name)
                  throw ((g.decoded = h), g)
                }
                t.populateDefaults && null !== l.defaultValue && (h[l.name] = l.defaultValue)
              }
            return h
          }),
          (o.Message = p)
        var c = function(e, i, r, n, o, a, l, f, h, u) {
            s.call(this, e, i, a),
              ...
              !this.builder.options.convertFieldsToCamelCase ||
                this instanceof p.ExtensionField ||
                (this.name = t.Util.toCamelCase(this.name))
          },
          g = (c.prototype = Object.create(s.prototype))
        ;(g.build = function() {
          ;(this.element = new h(this.type, this.resolvedType, !1, this.syntax)),
            this.map && (this.keyElement = new h(this.keyType, undefined, !0, this.syntax)),
            (this.defaultValue =
              'undefined' != typeof this.options['default'] ? this.verifyValue(this.options['default']) : null),
            'proto3' !== this.syntax ||
              this.repeated ||
              this.map ||
          ...
          (g.verifyValue = function(e, i) {
            ...
            if (null === e)
              return (
                this.required && r(typeof e, 'required'),
                'proto3' === this.syntax &&
                  this.type !== t.TYPES.message &&
                  r(typeof e, 'proto3 field without field presence cannot be null'),
                null
              )
            var n
            if (this.repeated && !i) {
            ...
            return this.map && !i
              ? e instanceof t.Map
                ? e
                : (e instanceof Object || r(typeof e, 'expected ProtoBuf.Map or raw object for map field'),
                  new t.Map(this, e))
              : (!this.repeated && Array.isArray(e) && r(typeof e, 'no array expected'), this.element.verifyValue(e))
          }),
              ...
              if (this.repeated) {
                ...
                if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                  ...
                  for (n = 0; n < i.length; n++)
                    r.writeVarint32((this.id << 3) | this.type.wireType), this.element.encodeValue(this.id, i[n], r)
              } else
                this.map
                  ...
                  : this.hasWirePresence(i) &&
                    (r.writeVarint32((this.id << 3) | this.type.wireType), this.element.encodeValue(this.id, i, r))
            } catch (f) {
              throw Error('Illegal value for ' + this.toString(!0) + ': ' + i + ' (' + f + ')')
            }
            return r
          }),
          (g.calculate = function(i) {
            ...
            try {
              if (this.repeated) {
                var n, o
                if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                  for (r += e.calculateVarint32((this.id << 3) | t.WIRE_TYPES.LDELIM), o = 0, n = 0; n < i.length; n++)
          ...
          (g.decode = function(e, i, r) {
            ...
            if (this.map) {
              var a = this.keyElement.defaultFieldValue(this.keyType)
              if (((n = this.element.defaultFieldValue(this.type)), (o = i.readVarint32()), i.remaining() < o))
                throw Error(
                  'Illegal number of bytes for ' +
                    this.toString(!0) +
                    ': ' +
              ...
              for (l.limit = l.offset + o, i.offset += o; l.remaining() > 0; ) {
                var f = l.readVarint32()
                e = 7 & f
                var h = f >>> 3
                if (1 === h) a = this.keyElement.decode(l, e, h)
                else {
          ...
          (o.Message.Field = c)
        var m = function(e, t, i, r, n, o, s) {
          c.call(this, e, t, i, null, r, n, o, s), this.extension
        }
        ;(m.prototype = Object.create(c.prototype)), (o.Message.ExtensionField = m)
        ...
        ;((E.prototype = Object.create(l.prototype)).build = function() {
          for (var e = {}, t = this.getChildren(E.Value), i = 0, r = t.length; i < r; ++i) e[t[i].name] = t[i].id
          return (
            Object.defineProperty && Object.defineProperty(e, '$options', { value: this.buildOpt() }), (this.object = e)
          )
        }),
          (o.Enum = E)
        ...
        ;(v.prototype = Object.create(s.prototype)), (o.Enum.Value = v)
        ...
        ;((b.prototype = Object.create(l.prototype)).build = function(i) {
          return this.clazz && !i
            ? this.clazz
            : (this.clazz = (function(t, i) {
                for (
                  var r = function(e) {
                        ...
                        (this.rpcImpl =
                          ...
                          function(e, t, i) {
                            setTimeout(
                              i.bind(
                                this,
                                Error('Not implemented, see: https://github.com/dcodeIO/ProtoBuf.js/wiki/Services')
                              ),
                              0
                            )
                          })
                    },
                    n = (r.prototype = Object.create(t.Builder.Service.prototype)),
                  ...
                  !(function(t) {
                    ;(n[t.name] = function(r, n) {
                      try {
                        ...
                        if (!(r && r instanceof t.resolvedRequestType.clazz))
                          return void setTimeout(
                            n.bind(
                              this,
                              Error('Illegal request type provided to service method ' + i.name + '#' + t.name)
                            ),
                            0
                          )
                        this.rpcImpl(t.fqn(), r, function(e, r) {
                          ...
                          if (!(r && r instanceof t.resolvedResponseType.clazz))
                            return void n(
                              Error('Illegal response type received in service method ' + i.name + '#' + t.name)
                            )
                          n(null, r)
                        })
                      } catch (o) {
                      ...
                      Object.defineProperty &&
                        ...
                        Object.defineProperty(n[t.name], '$options', { value: r[t.name].$options }))
                  })(o[s])
                return (
                  Object.defineProperty &&
                    (Object.defineProperty(r, '$options', { value: i.buildOpt() }),
                    Object.defineProperty(n, '$options', { value: r.$options }),
                    Object.defineProperty(r, '$type', { value: i }),
                    Object.defineProperty(n, '$type', { value: i })),
                  r
                )
              })(t, this))
        }),
        ...
        ;((T.prototype = Object.create(s.prototype)).buildOpt = f.buildOpt), (o.Service.Method = T)
        var I = function(e, t, i, r, n, o, s, a) {
          T.call(this, e, t, i, a),
        ...
        return (I.prototype = Object.create(T.prototype)), (o.Service.RPCMethod = I), o
      })(t)),
      (t.Builder = (function(e, t, i) {
        ...
        return (
          ...
          (n.isValidMessage = function(e) {
            ...
            if ('undefined' != typeof e.messages) {
              ...
              for (i = 0; i < e.messages.length; i++)
                if (!n.isValidMessage(e.messages[i]) && !n.isValidExtend(e.messages[i])) return !1
            }
            if (
              'undefined' != typeof e.extensions &&
              (!Array.isArray(e.extensions) ||
                2 !== e.extensions.length ||
                'number' != typeof e.extensions[0] ||
                'number' != typeof e.extensions[1])
            )
              return !1
            if ('proto3' === e.syntax) {
              for (i = 0; i < e.fields.length; i++) {
                ...
                if (s.options)
                  for (var a = Object.keys(s.options), l = 0; l < a.length; l++) if ('default' === a[l]) return !1
              }
          ...
          (n.isValidMessageField = function(e) {
            ...
            if ('undefined' != typeof e.options) {
              ...
              for (var i, r = Object.keys(e.options), n = 0; n < r.length; n++)
                if (
                  'string' != typeof (i = r[n]) ||
                  ('string' != typeof e.options[i] &&
                    'number' != typeof e.options[i] &&
                    'boolean' != typeof e.options[i])
                )
                  return !1
            }
            return !0
              ...
              for (; t.length > 0; ) {
                ...
                if (n.isValidMessage(o)) {
                  var s = new i.Message(this, this.ptr, o.name, o.options, o.isGroup, o.syntax),
                    a = {}
                  if (o.oneofs)
                    for (var l = Object.keys(o.oneofs), f = 0, h = l.length; f < h; ++f)
                      s.addChild((a[l[f]] = new i.Message.OneOf(this, s, l[f])))
                  if (o.fields && o.fields.length > 0)
                    for (f = 0, h = o.fields.length; f < h; ++f) {
                      var u = o.fields[f]
                      if (null !== s.getChild(u.id))
                        throw Error('Duplicate field id in message ' + s.name + ': ' + u.id)
                      if (u.options)
                        for (var p = Object.keys(u.options), d = 0, c = p.length; d < c; ++d) {
                          if ('string' != typeof p[d])
                            throw Error('Illegal field option name in message ' + s.name + '#' + u.name + ': ' + p[d])
                          if (
                            'string' != typeof u.options[p[d]] &&
                            'number' != typeof u.options[p[d]] &&
                            'boolean' != typeof u.options[p[d]]
                          )
                            throw Error(
                      ...
                      var g = null
                      if ('string' == typeof u.oneof && void 0 === (g = a[u.oneof]))
                        throw Error('Illegal oneof in message ' + s.name + '#' + u.name + ': ' + u.oneof)
                      ;(u = new i.Message.Field(
                        this,
                        s,
                        u.rule,
                        u.keytype,
                  ...
                  if ('undefined' != typeof o.enums && o.enums.length > 0)
                    for (f = 0; f < o.enums.length; f++) m.push(o.enums[f])
                  if (o.messages && o.messages.length > 0) for (f = 0; f < o.messages.length; f++) m.push(o.messages[f])
                  if (o.services && o.services.length > 0) for (f = 0; f < o.services.length; f++) m.push(o.services[f])
                  if (
                    (o.extensions &&
                    ...
                    r.push(t), (t = m), (m = null), (this.ptr = s), (s = null)
                    continue
                  }
                  ;(m = null), (s = null)
                } else if (n.isValidEnum(o)) {
                  for (s = new i.Enum(this, this.ptr, o.name, o.options, o.syntax), f = 0; f < o.values.length; f++)
                  ...
                  for (f in o.rpc)
                    o.rpc.hasOwnProperty(f) &&
                      s.addChild(
                        new i.Service.RPCMethod(
                          this,
                          s,
                          f,
                          o.rpc[f].request,
                          o.rpc[f].response,
                          !!o.rpc[f].request_stream,
                          !!o.rpc[f].response_stream,
                          o.rpc[f].options
                        )
                      )
                  this.ptr.addChild(s), (s = null)
                  ...
                  if ((s = this.ptr.resolve(o.ref, !0)))
                    for (f = 0; f < o.fields.length; f++) {
                      ...
                      var E = new i.Extension(this, this.ptr, o.fields[f].name, u)
                      ;(u.extension = E), this.ptr.addChild(E), s.addChild(u)
                    }
          ...
          (o['import'] = function(t, i) {
            if ('string' == typeof i) {
              if ((e.Util.IS_NODE && (i = require('path').resolve(i)), !0 === this.files[i])) return this.reset(), this
              this.files[i] = !0
            } else if ('object' == typeof i) {
              var n = i.root
              e.Util.IS_NODE && (n = require('path').resolve(n))
              var o = [n, i.file].join('/')
              if (!0 === this.files[o]) return this.reset(), this
              this.files[o] = !0
            }
            if (t.imports && t.imports.length > 0) {
              ...
              for (var f = 0; f < t.imports.length; f++)
                if ('string' == typeof t.imports[f]) {
                  ...
                  if (((h = s + a + h), !0 === this.files[h])) continue
                  ;/\.proto$/i.test(h) && !e.DotProto && (h = h.replace(/\.proto$/, '.json'))
                  var u = e.Util.fetch(h)
                  if (null === u) throw Error("Failed to import '" + h + "' in '" + i + "': File not found")
                  ;/\.json$/i.test(h)
                    ? this['import'](JSON.parse(u + ''), h)
                    : this['import'](new e.DotProto.Parser(u + '').parse(), h)
                } else
                  i
                    ? /\.(\w+)$/.test(i)
                      ? this['import'](
                          t.imports[f],
                          i.replace(/^(.+)\.(\w+)$/, function(e, t, i) {
                            return t + '_import' + f + '.' + i
                          })
                        )
                      : this['import'](t.imports[f], i + '_import' + f)
          ...
          (o.resolveAll = function() {
            ...
            if (null != this.ptr && 'object' != typeof this.ptr.type) {
              if (this.ptr instanceof i.Namespace)
                for (var n = this.ptr.children, o = 0, s = n.length; o < s; ++o) (this.ptr = n[o]), this.resolveAll()
                ...
                if (t.TYPE.test(this.ptr.type)) this.ptr.type = e.TYPES[this.ptr.type]
                  ...
                  if (
                    !(r = (this.ptr instanceof i.Message.ExtensionField
                  ...
                  if (((this.ptr.resolvedType = r), r instanceof i.Enum)) {
                    if (((this.ptr.type = e.TYPES['enum']), 'proto3' === this.ptr.syntax && 'proto3' !== r.syntax))
                      throw Error(
                        'Proto3 message refers to proto2 enum; this is not allowed due to differing enum semantics in proto3'
                      )
                  } else {
                ...
                if (!((r = this.ptr.parent.resolve(this.ptr.requestName, !0)) && r instanceof e.Reflect.Message))
                  throw Error('Illegal type reference in ' + this.ptr.toString(!0) + ': ' + this.ptr.requestName)
                if (
                  ((this.ptr.resolvedRequestType = r),
                  !((r = this.ptr.parent.resolve(this.ptr.responseName, !0)) && r instanceof e.Reflect.Message))
                )
      ...
      (t.Map = (function(e, t) {
        ...
        return (
          ...
          (n.get = function(e) {
            var t = this.keyElem.valueToString(this.keyElem.verifyValue(e))
            return t in this.map ? this.map[t].value : undefined
          }),
          (n.has = function(e) {
      ...
      (t.loadProto = function(e, i, r) {
        return (
          ('string' == typeof i || (i && 'string' == typeof i.file && 'string' == typeof i.root)) &&
            ((r = i), (i = undefined)),
      ...
      (t.loadProtoFile = function(e, i, r) {
        if ((i && 'object' == typeof i ? ((r = i), (i = null)) : (i && 'function' == typeof i) || (i = null), i))
    ...
    var r = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',
        ...
        switch (e.length) {
          case 4:
            var t =
                ...
                (63 & e.charCodeAt(3)),
              i = t - 65536
            return o(55296 + (i >>> 10)) + o(56320 + (1023 & i))
          case 3:
      ...
      y = function(e) {
        var t = e.length,
          i = t % 4,
          r =
            (t > 0 ? n[e.charAt(0)] << 18 : 0) |
            (t > 1 ? n[e.charAt(1)] << 12 : 0) |
            (t > 2 ? n[e.charAt(2)] << 6 : 0) |
            (t > 3 ? n[e.charAt(3)] : 0),
...
!(function(e) {
  ...
  function l(e, i) {
    ...
    for (r = 0; r < e.length; r += 16)
      (l = p),
        ...
        (h = c),
        (u = g),
        (p = n(p, d, c, g, e[r], 7, -680876936)),
        (g = n(g, p, d, c, e[r + 1], 12, -389564586)),
        (c = n(c, g, p, d, e[r + 2], 17, 606105819)),
        (d = n(d, c, g, p, e[r + 3], 22, -1044525330)),
        (p = n(p, d, c, g, e[r + 4], 7, -176418897)),
        (g = n(g, p, d, c, e[r + 5], 12, 1200080426)),
        (c = n(c, g, p, d, e[r + 6], 17, -1473231341)),
        (d = n(d, c, g, p, e[r + 7], 22, -45705983)),
        (p = n(p, d, c, g, e[r + 8], 7, 1770035416)),
        (g = n(g, p, d, c, e[r + 9], 12, -1958414417)),
        (c = n(c, g, p, d, e[r + 10], 17, -42063)),
        (d = n(d, c, g, p, e[r + 11], 22, -1990404162)),
        (p = n(p, d, c, g, e[r + 12], 7, 1804603682)),
        (g = n(g, p, d, c, e[r + 13], 12, -40341101)),
        (c = n(c, g, p, d, e[r + 14], 17, -1502002290)),
        (d = n(d, c, g, p, e[r + 15], 22, 1236535329)),
        (p = o(p, d, c, g, e[r + 1], 5, -165796510)),
        (g = o(g, p, d, c, e[r + 6], 9, -1069501632)),
        (c = o(c, g, p, d, e[r + 11], 14, 643717713)),
        (d = o(d, c, g, p, e[r], 20, -373897302)),
        (p = o(p, d, c, g, e[r + 5], 5, -701558691)),
        (g = o(g, p, d, c, e[r + 10], 9, 38016083)),
        (c = o(c, g, p, d, e[r + 15], 14, -660478335)),
        (d = o(d, c, g, p, e[r + 4], 20, -405537848)),
        (p = o(p, d, c, g, e[r + 9], 5, 568446438)),
        (g = o(g, p, d, c, e[r + 14], 9, -1019803690)),
        (c = o(c, g, p, d, e[r + 3], 14, -187363961)),
        (d = o(d, c, g, p, e[r + 8], 20, 1163531501)),
        (p = o(p, d, c, g, e[r + 13], 5, -1444681467)),
        (g = o(g, p, d, c, e[r + 2], 9, -51403784)),
        (c = o(c, g, p, d, e[r + 7], 14, 1735328473)),
        (d = o(d, c, g, p, e[r + 12], 20, -1926607734)),
        (p = s(p, d, c, g, e[r + 5], 4, -378558)),
        (g = s(g, p, d, c, e[r + 8], 11, -2022574463)),
        (c = s(c, g, p, d, e[r + 11], 16, 1839030562)),
        (d = s(d, c, g, p, e[r + 14], 23, -35309556)),
        (p = s(p, d, c, g, e[r + 1], 4, -1530992060)),
        (g = s(g, p, d, c, e[r + 4], 11, 1272893353)),
        (c = s(c, g, p, d, e[r + 7], 16, -155497632)),
        (d = s(d, c, g, p, e[r + 10], 23, -1094730640)),
        (p = s(p, d, c, g, e[r + 13], 4, 681279174)),
        (g = s(g, p, d, c, e[r], 11, -358537222)),
        (c = s(c, g, p, d, e[r + 3], 16, -722521979)),
        (d = s(d, c, g, p, e[r + 6], 23, 76029189)),
        (p = s(p, d, c, g, e[r + 9], 4, -640364487)),
        (g = s(g, p, d, c, e[r + 12], 11, -421815835)),
        (c = s(c, g, p, d, e[r + 15], 16, 530742520)),
        (d = s(d, c, g, p, e[r + 2], 23, -995338651)),
        (p = a(p, d, c, g, e[r], 6, -198630844)),
        (g = a(g, p, d, c, e[r + 7], 10, 1126891415)),
        (c = a(c, g, p, d, e[r + 14], 15, -1416354905)),
        (d = a(d, c, g, p, e[r + 5], 21, -57434055)),
        (p = a(p, d, c, g, e[r + 12], 6, 1700485571)),
        (g = a(g, p, d, c, e[r + 3], 10, -1894986606)),
        (c = a(c, g, p, d, e[r + 10], 15, -1051523)),
        (d = a(d, c, g, p, e[r + 1], 21, -2054922799)),
        (p = a(p, d, c, g, e[r + 8], 6, 1873313359)),
        (g = a(g, p, d, c, e[r + 15], 10, -30611744)),
        (c = a(c, g, p, d, e[r + 6], 15, -1560198380)),
        (d = a(d, c, g, p, e[r + 13], 21, 1309151649)),
        (p = a(p, d, c, g, e[r + 4], 6, -145523070)),
        (g = a(g, p, d, c, e[r + 11], 10, -1120210379)),
        (c = a(c, g, p, d, e[r + 2], 15, 718787259)),
        (d = a(d, c, g, p, e[r + 9], 21, -343485551)),
        (p = t(p, l)),
        (d = t(d, f)),
        (c = t(c, h)),
        (g = t(g, u))
  ...
  function h(e) {
    var t,
      i = []
    for (i[(e.length >> 2) - 1] = undefined, t = 0; t < i.length; t += 1) i[t] = 0
    for (t = 0; t < 8 * e.length; t += 8) i[t >> 5] |= (255 & e.charCodeAt(t / 8)) << (t % 32)
    return i
  }
  function u(e) {
    return f(l(h(e), 8 * e.length))
  }
  function p(e, t) {
    var i,
      r,
      ...
      o = [],
      s = []
    for (o[15] = s[15] = undefined, n.length > 16 && (n = l(n, 8 * e.length)), i = 0; i < 16; i += 1)
      (o[i] = 909522486 ^ n[i]), (s[i] = 1549556828 ^ n[i])
    return (r = l(o.concat(h(t)), 512 + 8 * t.length)), f(l(s.concat(r), 640))
  }
  function d(e) {
    var t,
      i,
  ...
  function v(e, t, i) {
    return t ? (i ? y(t, e) : E(t, e)) : i ? g(e) : m(e)
  }
  'function' == typeof define && define.amd
    ? define(function() {
        return v
  ...
  function() {
    ...
    ;(r.getListeners = function(e) {
      ...
      (r.removeListener = function(e, i) {
        ...
        for (n in o) o.hasOwnProperty(n) && -1 !== (r = t(o[n], i)) && o[n].splice(r, 1)
        return this
      }),
      ...
      (r.manipulateListeners = function(e, t, i) {
        ...
        if ('object' != typeof t || t instanceof RegExp) for (r = i.length; r--; ) o.call(this, t, i[r])
        else
          for (r in t)
      ...
      (r.emitEvent = function(e, t) {
        ...
        for (n in o)
          if (o.hasOwnProperty(n))
            for (r = o[n].length; r--; )
              (i = o[n][r]),
                !0 === i.once && this.removeListener(e, i.listener),
    ...
    messages: [
      {
        name: 'Pair',
        fields: [
          { rule: 'required', type: 'bytes', name: 'key', id: 1 },
      ...
      },
      {
        name: 'Error',
        fields: [
          { rule: 'required', type: 'uint32', name: 'id', id: 1 },
          { rule: 'optional', type: 'bytes', name: 'description', id: 2 }
        ]
      },
      {
        name: 'User',
        fields: [
          { rule: 'required', type: 'string', name: 'userid', id: 1 },
          { rule: 'repeated', type: 'Pair', name: 'property_pairs', id: 2 }
        ]
      },
      { name: 'Info', fields: [{ rule: 'repeated', type: 'Pair', name: 'property_pairs', id: 1 }] },
      {
        name: 'LoginReq',
        fields: [
          { rule: 'required', type: 'string', name: 'mobile_type', id: 1 },
          { rule: 'required', type: 'uint32', name: 'net_type', id: 2 },
          { rule: 'required', type: 'string', name: 'server_ram', id: 3 },
          { rule: 'optional', type: 'bytes', name: 'secret_ram', id: 4 },
          { rule: 'optional', type: 'uint32', name: 'app_id', id: 5, options: { default: 2e3 } },
          { rule: 'optional', type: 'uint32', name: 'heart_feq', id: 6, options: { default: 300 } },
          { rule: 'optional', type: 'string', name: 'deviceid', id: 7, options: { default: '' } },
          { rule: 'optional', type: 'string', name: 'platform', id: 8 },
          { rule: 'optional', type: 'string', name: 'verf_code', id: 9 },
          { rule: 'optional', type: 'bool', name: 'not_encrypt', id: 10 }
        ]
      },
      {
        name: 'LoginResp',
        fields: [
          { rule: 'required', type: 'uint32', name: 'timestamp', id: 1 },
          { rule: 'required', type: 'string', name: 'session_id', id: 2 },
          { rule: 'required', type: 'string', name: 'session_key', id: 3 },
          { rule: 'optional', type: 'string', name: 'client_login_ip', id: 4 },
      ...
      },
      {
        name: 'ChatReq',
        fields: [
          { rule: 'required', type: 'bytes', name: 'body', id: 1 },
          { rule: 'optional', type: 'uint32', name: 'body_id', id: 2 },
          { rule: 'optional', type: 'uint32', name: 'more_flag', id: 3 },
          { rule: 'required', type: 'uint32', name: 'body_type', id: 4 },
          { rule: 'optional', type: 'bool', name: 'store', id: 5 },
          { rule: 'optional', type: 'bytes', name: 'm_parameter', id: 6 },
          { rule: 'optional', type: 'uint32', name: 'service_id', id: 7 },
          { rule: 'optional', type: 'bytes', name: 's_parameter', id: 8 },
          { rule: 'optional', type: 'uint32', name: 'expire_time', id: 12 }
        ]
      },
      {
        name: 'ChatResp',
        fields: [
          { rule: 'required', type: 'uint32', name: 'result', id: 1 },
          { rule: 'optional', type: 'uint32', name: 'body_id', id: 2 }
        ]
      },
      {
        name: 'GetInfoReq',
        fields: [
          { rule: 'required', type: 'string', name: 'info_type', id: 1 },
          { rule: 'required', type: 'int64', name: 'get_info_id', id: 2 },
          { rule: 'optional', type: 'int32', name: 'get_info_offset', id: 3 },
          { rule: 'optional', type: 'bytes', name: 's_parameter', id: 4 }
        ]
      },
      {
        name: 'GetInfoResp',
        fields: [
          { rule: 'required', type: 'string', name: 'info_type', id: 1 },
          { rule: 'repeated', type: 'Info', name: 'infos', id: 2 },
          { rule: 'optional', type: 'int64', name: 'last_info_id', id: 3 },
          { rule: 'optional', type: 'bytes', name: 's_parameter', id: 4 }
        ]
      },
      {
        name: 'GetMultiInfosReq',
        fields: [
          { rule: 'required', type: 'string', name: 'info_type', id: 1 },
          { rule: 'repeated', type: 'int64', name: 'get_info_ids', id: 2 },
          { rule: 'optional', type: 'bytes', name: 's_parameter', id: 3 }
        ]
      },
      {
        name: 'GetMultiInfosResp',
        fields: [
          { rule: 'required', type: 'string', name: 'info_type', id: 1 },
          { rule: 'repeated', type: 'Info', name: 'infos', id: 2 },
          { rule: 'optional', type: 'int64', name: 'last_info_id', id: 3 },
      ...
      { name: 'LogoutResp', fields: [{ rule: 'required', type: 'uint32', name: 'result', id: 1 }] },
      {
        name: 'InitLoginReq',
        fields: [
          { rule: 'required', type: 'string', name: 'client_ram', id: 1 },
          { rule: 'optional', type: 'string', name: 'sig', id: 2 }
        ]
      },
      {
        name: 'InitLoginResp',
        fields: [
          { rule: 'required', type: 'string', name: 'client_ram', id: 1 },
          { rule: 'required', type: 'string', name: 'server_ram', id: 2 }
        ]
      },
      {
        name: 'Service_Req',
        fields: [
          { rule: 'required', type: 'uint32', name: 'service_id', id: 1 },
          { rule: 'required', type: 'bytes', name: 'request', id: 2 }
        ]
      },
      {
        name: 'Service_Resp',
        fields: [
          { rule: 'required', type: 'uint32', name: 'service_id', id: 1 },
          { rule: 'required', type: 'bytes', name: 'response', id: 2 }
        ]
      },
      {
        name: 'ReqEQ1User',
        fields: [
          { rule: 'required', type: 'string', name: 'userid', id: 1 },
          { rule: 'required', type: 'string', name: 'user_type', id: 2 },
      ...
      },
      {
        ...
        fields: [
          ...
          { rule: 'optional', type: 'string', name: 'jid', id: 4 },
          { rule: 'optional', type: 'uint32', name: 'app_id', id: 5 },
          { rule: 'optional', type: 'string', name: 'platform', id: 6 },
          { rule: 'optional', type: 'string', name: 'mobile_type', id: 7 },
          { rule: 'optional', type: 'uint32', name: 'client_ver', id: 8 }
        ]
      },
      { name: 'Ex1QueryUserStatusReq', fields: [{ rule: 'repeated', type: 'ReqEQ1User', name: 'user_list', id: 1 }] },
      { name: 'Ex1QueryUserStatusResp', fields: [{ rule: 'repeated', type: 'RespEQ1User', name: 'user_list', id: 1 }] },
      {
        name: 'Request',
        fields: [
          { rule: 'optional', type: 'LoginReq', name: 'login', id: 2 },
          { rule: 'optional', type: 'ChatReq', name: 'chat', id: 3 },
          { rule: 'optional', type: 'GetInfoReq', name: 'get_info', id: 5 },
          { rule: 'optional', type: 'LogoutReq', name: 'logout', id: 6 },
          { rule: 'optional', type: 'InitLoginReq', name: 'init_login_req', id: 9 },
          { rule: 'optional', type: 'Service_Req', name: 'service_req', id: 11 },
          { rule: 'optional', type: 'Ex1QueryUserStatusReq', name: 'e1_query_user', id: 12 },
          {
            rule: 'optional',
            type: 'GetMultiInfosReq',
            name: 'get_multi_infos',
            id: 100
          }
        ]
      },
      {
        name: 'Response',
        fields: [
          { rule: 'optional', type: 'Error', name: 'error', id: 1 },
          { rule: 'optional', type: 'LoginResp', name: 'login', id: 3 },
          { rule: 'optional', type: 'ChatResp', name: 'chat', id: 4 },
          { rule: 'optional', type: 'GetInfoResp', name: 'get_info', id: 6 },
          { rule: 'optional', type: 'LogoutResp', name: 'logout', id: 7 },
          { rule: 'optional', type: 'InitLoginResp', name: 'init_login_resp', id: 10 },
          { rule: 'optional', type: 'Service_Resp', name: 'service_resp', id: 12 },
          { rule: 'optional', type: 'Ex1QueryUserStatusResp', name: 'e1_query_user', id: 13 },
          { rule: 'optional', type: 'GetMultiInfosResp', name: 'get_multi_infos', id: 100 }
        ]
      },
      {
        ...
        fields: [
          { rule: 'required', type: 'string', name: 'info_type', id: 1 },
          { rule: 'optional', type: 'bytes', name: 'info_content', id: 2 },
          { rule: 'optional', type: 'int64', name: 'info_id', id: 3 },
          { rule: 'optional', type: 'uint32', name: 'query_after_seconds', id: 4 }
        ]
      },
      { name: 'ReLoginNotify', fields: [{ rule: 'optional', type: 'string', name: 'new_ip', id: 1 }] },
      {
        name: 'ReConnectNotify',
        fields: [
          { rule: 'optional', type: 'string', name: 'ip', id: 1 },
          { rule: 'optional', type: 'uint32', name: 'port', id: 2 },
          { rule: 'repeated', type: 'string', name: 'more_ips', id: 3 }
        ]
      },
      {
        name: 'Notify',
        fields: [
          { rule: 'optional', type: 'NewMessageNotify', name: 'newinfo_ntf', id: 1 },
          { rule: 'optional', type: 'ReLoginNotify', name: 'relogin_ntf', id: 2 },
      ...
      { name: 'Ack', fields: [{ rule: 'required', type: 'uint32', name: 'result', id: 1 }] },
      {
        name: 'RouteInfo',
        fields: [
          { rule: 'required', type: 'bytes', name: 'username', id: 1 },
          { rule: 'required', type: 'string', name: 'msg_exchanger', id: 2 },
      ...
      },
      {
        name: 'Proxy',
        fields: [
          { rule: 'required', type: 'string', name: 'sender', id: 1 },
          { rule: 'repeated', type: 'RouteInfo', name: 'receiver', id: 2 }
        ]
      },
      {
        name: 'Message',
        fields: [
          { rule: 'required', type: 'uint32', name: 'msgid', id: 1 },
          { rule: 'required', type: 'uint64', name: 'sn', id: 2 },
          { rule: 'optional', type: 'string', name: 'sender', id: 3 },
          { rule: 'optional', type: 'string', name: 'receiver', id: 4 },
          { rule: 'optional', type: 'string', name: 'receiver_type', id: 5 },
          { rule: 'optional', type: 'Request', name: 'req', id: 6 },
          { rule: 'optional', type: 'Response', name: 'resp', id: 7 },
          { rule: 'optional', type: 'Notify', name: 'notify', id: 8 },
          { rule: 'optional', type: 'Ack', name: 'ack', id: 9 },
          { rule: 'optional', type: 'Proxy', name: 'proxy_mesg', id: 10 },
          { rule: 'optional', type: 'uint64', name: 'client_data', id: 11 },
          { rule: 'optional', type: 'string', name: 'sender_type', id: 12 },
...
!(function(e) {
  ...
  var i = e.dcodeIO.ByteBuffer,
    ...
    u = {
      ...
      randomString: function(e, t) {
        for (var i = [], r = t ? f.slice(0, 10) : f, n = 0; n < e; n++)
          i.push(r.charAt(Math.floor(Math.random() * r.length)))
        return i.join('')
      },
      randomNumber: function(e) {
        return parseInt(u.randomString(e, !0), 10)
      },
      defaultKey: (function() {
        function e(e) {
          return r.decode(n.decode(e), t)
        }
        var t = 'socketio',
          i = e('w7h6VMOWbcKqCGA='),
          o = e('wqh+VMKMO8KrCzE='),
    ...
    p = {
      wp: (function() {
        return -1 !== o.indexOf('windows phone ')
      ...
      android: (function() {
        return -1 !== o.indexOf('android')
          ? /\bandroid[ \/-]?([0-9.x]+)?/
          : -1 !== o.indexOf('adr')
            ? -1 !== o.indexOf('mqqbrowser')
              ? /\badr[ ]\(linux; u; ([0-9.]+)?/
              : /\badr(?:[ ]([0-9.]+))?/
            : /\bandroid/
      })().test(o)
  ...
  u.extend(m.prototype, {
    ...
    _init: function(t) {
      var i = this
      if (((this.config = u.extend(u.extend({}, this.defaultConfig), t)), !this.config.roomId))
        throw new Error('WebSocketIO\u521d\u59cb\u5316\u5931\u8d25\uff1a\u7f3a\u5c11roomId')
      ;(this.config.roomId = String(this.config.roomId)),
        this.config.debug || (h = a),
        (this.config.sender = String(this.config.userId) || String(this.config.sender)),
        this.config.sender || (this.config.sender = u.randomString(11, !0) + Date.now()),
        this.config.password || (this.config.password = this.config.sender),
        e._addressBookProtoBuilder && e._chatroomProtoBuilder
          ? ((this._addressBookProto = e._addressBookProtoBuilder), (this._chatroomProto = e._chatroomProtoBuilder))
          : h('WebSocketIO\u521d\u59cb\u5316\u5931\u8d25\uff1a\u7f3a\u5c11\u5fc5\u8981\u7684proto\u6587\u4ef6'),
      ...
      this.connect(),
        (e.onbeforeunload = function() {
          ;(i.socket.onclose = function() {}), i.close()
        })
    },
    ...
    _newAddressBookMessage: function(e, t) {
      return new (this._getProtoMessage('addressBook', 'qihoo.protocol.messages.' + e))(t)
    },
    _newChatroomMessage: function(e, t) {
      return new (this._getProtoMessage('chatroom', 'qihoo.protocol.chatroom.' + e))(t)
    },
    _newChatroomRequestMessage: function(e) {
      var t = this.config,
        r = new i(t.roomId.length)
          .writeString(t.roomId)
          .flip()
          .toArrayBuffer()
      return this._newChatroomMessage('ChatRoomPacket', {
        ...
        roomid: r,
        appid: t.appId,
        uuid: md5(u.randomString(10) + u.leftPad(++l, 10, '0') + Date.now()),
    ...
    _parseChatroomNewMessage: function(e) {
      return this._getProtoMessage('chatroom', 'qihoo.protocol.chatroom.ChatRoomNewMsg').decode(e)
    },
    ...
    _handleError: function(e) {
      ;(this.connectTryTimes = 0 | this.connectTryTimes),
        this.connectTryTimes < 3 ? (++this.connectTryTimes, this.reconnect()) : this.emit('error')
    },
    _handleMessage: function(e) {
      this.handshake
        ? this.session == undefined
          ? this._processLoginPack(e.data)
          : this._processMessagePack(e.data)
        : this._processHandShakePack(e.data)
    },
    _sendHandshakePack: function() {
      ...
      n
        .writeString(e.flag)
        .writeInt8(e.protocolVersion << 4)
        .writeInt8(e.clientVersion)
        .writeInt16(e.appId)
        .writeInt32(0)
        .writeInt16(0),
        (t += n.view.byteLength),
        (t += 4)
      var o = this._newAddressBookRequestMessage(d.InitLoginReq, {
          init_login_req: this._newAddressBookMessage('InitLoginReq', {
            client_ram: u.randomString(10),
            sig: this._getCookie('sign')
          })
        }),
        s = r.encode(new Uint8Array(o.toArrayBuffer()), e.defaultKey)
      ;(t += s.byteLength),
        n
          .writeInt32(t)
          .append(s)
          .flip(),
        this._send(n.toArrayBuffer())
    },
    ...
    _processHandShakePack: function(e) {
      ...
      s.append(e)
      try {
        if (s.readString(2, i.METRICS_CHARS, 0).string !== o.flag)
        ...
        if (!this._sn || !n.sn || !n.sn.equals(this._sn))
          throw new Error('sn\u9a8c\u8bc1\u5931\u8d25, Message Type: ' + t(n.msgid))
        ;(this.handshake = !0), this.emit('handshake'), this._sendLoginPack(n.resp)
      } catch (a) {
        this.close(), h('WebSocketIO\u63e1\u624b\u5931\u8d25', a), this.emit('handshakefail')
      }
    },
    _sendLoginPack: function(e) {
      var t = this.config,
        ...
        o = 4,
        s = new i(4),
        a = e.init_login_resp.server_ram
      try {
        var l = this._newAddressBookRequestMessage(d.LoginReq, {
            login: this._newAddressBookMessage('LoginReq', {
              app_id: t.appId,
              server_ram: a,
              secret_ram: r.encode(new i(a.length + 8).writeString(a + u.randomString(8)).view, n),
              verf_code: u.makeVerfCode(t.sender),
              net_type: 4,
        ...
        ;(o += f.byteLength),
          s
            ...
            .append(f)
            .flip(),
          this._send(s.toArrayBuffer())
      } catch (c) {
        this.close(), h('WebSocketIO\u767b\u5f55\u5931\u8d25\uff1a\u767b\u5f55\u5305\u53d1\u9001\u5931\u8d25', c)
      }
    },
    _processLoginPack: function(e) {
      ...
      try {
        ...
        try {
          n =
            '' == this.session && this.session != undefined
              ? this._parseAddressBookMessage(a.toArrayBuffer())
              : this._parseAddressBookMessage(r.decode(a.toArrayBuffer(), s).buffer)
        } catch (l) {
          try {
        ...
        if (!this._sn || !n.sn || !n.sn.equals(this._sn))
          throw new Error('sn\u9a8c\u8bc1\u5931\u8d25, Message Type: ' + t(n.msgid))
        ;(n = n.resp),
          this._checkResponseError(n),
          (this.session = n.login.session_key),
          this.emit('login'),
          this._sendJoinChatroomPack(),
          this._initHeartBeat()
      } catch (l) {
        this.close(), h('WebSocketIO\u767b\u5f55\u5931\u8d25', l), this.emit('loginfail')
      }
    },
    ...
    _sendJoinChatroomPack: function() {
      ...
      try {
        ...
        if (this.session && '' != this.session) {
          var l = r.encode(new Uint8Array(a.toArrayBuffer()), this.session)
          ;(n += l.byteLength),
            o
              .writeInt32(n)
              .append(l)
          ...
          (n += a.toArrayBuffer().byteLength),
            o
              .writeInt32(n)
              .append(a.toArrayBuffer())
              .flip()
    ...
    _sendHeartbeatPack: function() {
      var e = this
      this._send(new i(4).writeInt32(0).buffer),
    ...
    _processMessagePack: function(e) {
      ...
      try {
        ...
        try {
          t =
            '' != this.session && this.session != undefined
              ? this._parseAddressBookMessage(r.decode(n.toArrayBuffer(), this.session).buffer)
              : this._parseAddressBookMessage(n.toArrayBuffer())
        } catch (s) {
          throw new Error('\u89e3\u6790\u6d88\u606f\u4f53\u5f02\u5e38')
        }
        var o = this._getMessageHandler(t.msgid)
        o && o.call(this, t)
      } catch (s) {
        h('WebSocketIO\u5904\u7406\u6d88\u606f\u5931\u8d25', s)
      }
    },
    ...
    _processService_RespMessage: function(e) {
      if (!this._sn || !e.sn || !e.sn.equals(this._sn))
        throw new Error('sn\u9a8c\u8bc1\u5931\u8d25, Message Type: ' + t(e.msgid))
      var i = this._parseChatroomMessage(e.resp.service_resp.response),
        r = i.to_user_data
      if (r.payloadtype === g.applyjoinchatroomresp || r.applyjoinchatroomresp)
        if ((clearTimeout(this._joinChatroomTimeout), (this._joinChatroomTimeout = null), r.result === g.successful)) {
          var n = parseInt(r.applyjoinchatroomresp.room.properties[1].value.toUTF8(), 10),
            o =
              r.applyjoinchatroomresp.room.partnerdata && JSON.parse(r.applyjoinchatroomresp.room.partnerdata.toUTF8()),
            s =
              r.applyjoinchatroomresp.room.partnerdata &&
              JSON.parse(r.applyjoinchatroomresp.room.partnerdata.toUTF8())['extends'].watches
          this.emit('joinchatroom', n, o && o.audiences, s)
        } else
          r.payloadtype === g.applyjoinchatroomresp
            ? this.emit('joinchatroomfail', r.result)
            : this.emit('joinchatroomfail')
      else
        (r.payloadtype === g.quitchatroomresp || r.quitchatroomresp) &&
          (clearTimeout(this._quitChatroomTimeout),
          (this._quitChatroomTimeout = null),
          r.result === g.successful ? this.emit('quitchatroom') : this.emit('quitchatroomfail'))
    },
    _processNewMessageNotifyMessage: function(e) {
      var t,
        i,
        r = this,
        n = this._parseChatroomMessage(e.notify.newinfo_ntf.info_content),
        o = n.to_user_data
      try {
        if (o && o.result === g.successful)
          if (o.payloadtype === g.newmsgnotify && o.newmsgnotify)
            0 === o.newmsgnotify.msgtype &&
              ((i = 0 | o.newmsgnotify.memcount),
              (t = o.newmsgnotify.msgcontent),
              (t = t && t.toUTF8()),
              (t = t && JSON.parse(t)) && this.emit('message', t, i))
          else if (o.payloadtype === g.memberjoinnotify && o.memberjoinnotify) {
            try {
              ;(i = parseInt(o.memberjoinnotify.room.properties[1].value.toUTF8(), 10)),
                (t = o.memberjoinnotify.room.members[0].userdata),
                (t = t && t.toUTF8()),
                (t = t && JSON.parse(t))
            } catch (a) {}
            this.emit('memberjoin', t, i)
          } else if (o.payloadtype === g.memberquitnotify && o.memberquitnotify) {
            try {
              ;(i = parseInt(o.memberquitnotify.room.properties[0].value.toUTF8(), 10)),
                (t = o.memberquitnotify.room.members[0].userid),
                (t = t && t.toUTF8())
            } catch (a) {}
            this.emit('memberquit', t, i)
          } else if (o.payloadtype === g.membergzipnotify && o.multinotify)
            try {
              for (var s = 0; s < o.multinotify.length; s++)
                (t = pako.ungzip(
                  o.multinotify[s].data.buffer.slice(o.multinotify[s].data.offset, o.multinotify[s].data.limit)
                )),
                  (t = r._parseChatroomNewMessage(t)),
                  (t = t.msgcontent.toUTF8()),
                  (t = t && JSON.parse(t)) && this.emit('message', t, 0)
            } catch (a) {
              console.log(a)
            }
      } catch (a) {}
